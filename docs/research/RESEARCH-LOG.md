...
All 22 section files of the 8 DEV exercises (02 plié, 03 tendu, 05 jeté,
06 piqué, 08 fondu, 10 adage, 11 grand battement, 12 relevés) now have
...
**Disclosed retry (house style):** `03_tendu_first_demo` failed on the
...
|---|---|---|---|---|---|---|---|
| 02-plie-demo | 127.7 | 4/4 | duple | plie | 64 | 196 | 0.153 |
| 02-plie-execution-left | 125.6 | 3/4 | none | unknown | — | 112 | 0.000 |
| 02-plie-execution-right | 119.2 | 4/4 | none | plie | 96 | 165 | 0.358 |
| 03-tendu-first-demo | 124.7 | 3/4 | none | tendu | 32 | 129 | 0.310 |
| 03-tendu-first-execution-left | — | 4/4 | none | tendu | — | 2 | 0.000 |
| 03-tendu-first-execution-right | 89.7 | 3/4 | none | tendu | 96 | 77 | 0.519 |
| 05-jete-demo | 82.0 | 4/4 | duple | battement_degage | 32 | 108 | 0.583 |
| 05-jete-execution-left | — | 3/4 | none | unknown | — | 0 | 0.000 |
| 05-jete-execution-right | 90.2 | 3/4 | none | tendu_plie_combination | 32 | 58 | 0.000 |
| 06-pique-demo | 91.2 | 4/4 | duple | piqué | 32 | 81 | 0.741 |
| 06-pique-execution-left | — | 4/4 | none | unknown | — | 0 | 0.000 |
| 06-pique-execution-right | 131.8 | 4/4 | none | pique_tendu | 32 | 42 | 0.690 |
| 08-fondu-demo | 83.3 | 4/4 | none | fondu | 24 | 118 | 0.229 |
| 08-fondu-execution-left | — | 4/4 | none | plie | — | 0 | 0.000 |
| 08-fondu-execution-right | 103.4 | 4/4 | none | fondu | 32 | 62 | 0.435 |
| 10-adage-demo | 81.5 | 4/4 | none | adagio | — | 133 | 0.451 |
| 10-adage-execution-left | — | 3/4 | none | unknown | — | 0 | 0.000 |
| 10-adage-execution-right | 75.5 | 4/4 | none | adagio | 32 | 111 | 0.279 |
| 11-grand-battement-demo | 109.4 | 4/4 | none | grand_battement | 32 | 119 | 0.311 |
| 11-grand-battement-execution-left | — | 3/4 | none | pas_de_valse | 96 | 0 | 0.000 |
| 11-grand-battement-execution-right | 107.1 | 4/4 | duple | battement | — | 41 | 0.878 |
| 12-releves-stretch | 113.8 | 3/4 | none | releve | 96 | 165 | 0.121 |
...
* **I1 — MISSED, and the miss is the finding.** 22/22 traces exist, but
  ...
  `execution_left` clips transcribe to zero words** (tendu-left: two),
...
* **I5 — UNTESTABLE as written, 1/1 on what survived.** Six of the seven
  ...
  pair agrees: plié L 125.6 / R 119.2, 5.1% apart. Recording this as a
...
filename slot on several rows (`05-jete-demo` → `battement_degage`,
`11-grand-battement-execution-right` → `battement`), the meter column
