...
| [015](adr/015-onset-measurement-robustness.md) | Onset measurement robustness — grid-fitting the IOIs (**Proposed**: agogic half confirmed, kill criterion tripped on two rows) |
